...
internal val logger: SkipLogger = SkipLogger(subsystem = "skip.diary.demo", category = "SkipDiaryDemo")
...
open class MainActivity: AppCompatActivity {
    ...
    override fun onStart() {
        super.onStart()
        SkipDiaryDemoAppDelegate.shared.onStart(this)
    }

    override fun onResume() {
        super.onResume()
        SkipDiaryDemoAppDelegate.shared.onResume(this)
    }

    override fun onPause() {
        super.onPause()
        SkipDiaryDemoAppDelegate.shared.onPause(this)
    }

    override fun onStop() {
        super.onStop()
        SkipDiaryDemoAppDelegate.shared.onStop(this)
    }

    override fun onDestroy() {
        super.onDestroy()
        SkipDiaryDemoAppDelegate.shared.onDestroy(this)
    }

    override fun onLowMemory() {
        super.onLowMemory()
        SkipDiaryDemoAppDelegate.shared.onLowMemory(this)
    }
...
internal fun PresentationRootView(context: ComposeContext) {
    ...
    PresentationRoot(defaultColorScheme = colorScheme, context = context) { ctx ->
        ...
        Box(modifier = ctx.modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            SkipDiaryDemoRootView().Compose(context = contentContext)
        }
    }
}
