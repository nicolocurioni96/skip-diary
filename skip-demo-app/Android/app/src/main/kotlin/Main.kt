...
internal val logger: SkipLogger = SkipLogger(subsystem = "skip.demo", category = "SkipDemo")
...
open class MainActivity: AppCompatActivity {
    ...
    override fun onStart() {
        super.onStart()
        SkipDemoAppDelegate.shared.onStart(this)
    }

    override fun onResume() {
        super.onResume()
        SkipDemoAppDelegate.shared.onResume(this)
    }

    override fun onPause() {
        super.onPause()
        SkipDemoAppDelegate.shared.onPause(this)
    }

    override fun onStop() {
        super.onStop()
        SkipDemoAppDelegate.shared.onStop(this)
    }

    override fun onDestroy() {
        super.onDestroy()
        SkipDemoAppDelegate.shared.onDestroy(this)
    }

    override fun onLowMemory() {
        super.onLowMemory()
        SkipDemoAppDelegate.shared.onLowMemory(this)
    }
...
internal fun PresentationRootView(context: ComposeContext) {
    ...
    PresentationRoot(defaultColorScheme = colorScheme, context = context) { ctx ->
        ...
        Box(modifier = ctx.modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            SkipDemoRootView().Compose(context = contentContext)
        }
    }
}
